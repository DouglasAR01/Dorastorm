<template>
  <nav class="navbar navbar-expand-sm navbar-light bg-light border-bottom">
    <router-link :to="{ name: 'home', params: {locale: $route.params.locale} }" class="navbar-brand">
      Dorastorm
    </router-link>
    ...
    <base-navbar-collapse-list>
      ...
      <single-navbar-list-element v-if="!isLoggedIn">
        <router-link :to="{ name: 'posts-index', params: {locale: $route.params.locale} }" class="nav-link">
          {{ $t("modules.posts.index") }}
        </router-link>
      </single-navbar-list-element>
      <!-- Login -->
      <single-navbar-list-element v-if="!isLoggedIn">
        <router-link :to="{ name: 'login', params: {locale: $route.params.locale} }" class="nav-link">
          {{ $t("navbar.login") }}
        </router-link>
      </single-navbar-list-element>
      <!-- Quotes -->
      <single-navbar-list-element v-if="isLoggedIn && checkUserPermission(loggedUser, corePms.READ_QUOTES)">
        <router-link :to="{ name: 'quotes-index', params: {locale: $route.params.locale} }" class="nav-link">
      ...
      <navbar-list-dropdown-element cid="posts" v-if="isLoggedIn">
        ...
        <router-link
          :to="{ name: 'posts-create', params: {locale: $route.params.locale} }"
          class="nav-link"
        ...
        <router-link
          :to="{ name: 'user-posts', params: {locale: $route.params.locale} }"
          class="nav-link"
          v-if="checkUserPermission(loggedUser, corePms.CREATE_POSTS)"
        >
        ...
        <hr class="w-75 my-1" />
        <router-link class="nav-link" :to="{ name: 'posts-index', params: {locale: $route.params.locale} }">
          {{ $t("modules.posts.index") }}
        </router-link>
        <router-link class="nav-link" :to="{ name: 'private-posts-index', params: {locale: $route.params.locale} }">
      ...
      >
        ...
        <router-link
          :to="{ name: 'users-index', params: {locale: $route.params.locale} }"
        ...
        <router-link
          :to="{ name: 'users-create', params: {locale: $route.params.locale} }"
      ...
      >
        ...
        <router-link
          :to="{ name: 'roles-index', params: {locale: $route.params.locale} }"
        ...
        <router-link
          class="nav-link"
          :to="{ name: 'roles-create', params: {locale: $route.params.locale} }"
      ...
      <single-navbar-list-element classes="ml-sm-3" v-if="isLoggedIn">
        <router-link :to="{ name: 'me', params: {locale: $route.params.locale} }" class="nav-link">
